def draft_cover_letter_prompt(experience: str, job_description: str) -> str:
    ...
    5. Flowing Prose Only: Write entirely in cohesive, flowing paragraphs.
    6. No Bullet Points: STRICTLY PROHIBITED. Do not use bullet points or numbered lists anywhere in the text, under any circumstances.
...
def modify_cover_letter_prompt(experience: str, job_description: str, draft_cover_letter: str, evaluation: str, user_notes: str) -> str:
    ...
    - Flowing Prose Only: Write entirely in cohesive, flowing paragraphs.
    - No Bullet Points: STRICTLY PROHIBITED. Do not use bullet points or numbered lists anywhere in the text, under any circumstances.
